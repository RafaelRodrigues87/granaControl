...
import { AdicionarReceita, ListarReceitaUsuario } from "../../service/ReceitaService";
...
const handleSubmit = async (e) => {
  ...
  try {
    const dadosParaEnviar = {
      ...
      conta: { id: Number(novaReceita.contaId) } // Sem categoria aqui
    };
        ...
        >
          <div className="card border-0 rounded-4 p-4 shadow-lg" style={{ width: "95%", maxWidth: 480, backgroundColor: "#fff" }}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-4">
                <label className="fw-bold text-muted mb-2 d-block small text-uppercase">Vincular à Conta (ID)</label>
                <input
                  type="number"
                  className="form-control rounded-3 border-0"
